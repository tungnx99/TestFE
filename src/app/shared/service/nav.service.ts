...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		...
		{
			title: 'Category', path: '/category', icon: 'box', type: 'link', active: false
		},
		{
			title: 'Supplier', path: '/supplier', icon: 'box', type: 'link', active: false
		},
		{
			title: 'Product', path: '/product', icon: 'box', type: 'link', active: false
		},
		{
